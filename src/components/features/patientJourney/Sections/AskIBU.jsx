...
const AskIBU = () =>
{
  const questionData = [
    ...
    },
    {
      ...
      region: "Europe",
      country: "Germany",
      answer: "Blockchain is a distributed ledger technology that stores data in blocks linked together in a chain.",
    ...
    },
    {
      ...
      region: "Asia",
      country: "India",
      answer: "Renewable energy sources include solar, wind, hydro, and geothermal energy.",
    ...
    },
    {
      ...
      region: "Oceania",
      country: "Australia",
      answer: "Cloud computing allows users to store and access data and applications over the internet.",
    ...
    },
    {
      ...
      region: "North America",
      country: "Canada",
      answer: "Machine learning is a subset of AI focused on enabling systems to learn from data automatically.",
      tags: ["AI", "ML", "data"],
      date: "2025-01-18"
    },
    {
      ...
      region: "Europe",
      country: "France",
      answer: "Remote work increases flexibility, productivity, and work-life balance for employees.",
    ...
    },
    {
      ...
      region: "Asia",
      country: "Japan",
      answer: "Cybersecurity is the practice of protecting systems and networks from digital attacks.",
    ...
    },
    {
      ...
      country: "Brazil",
      answer: "Data visualization represents data graphically to identify trends, patterns, and insights.",
    ...
    },
    {
      ...
      region: "Europe",
      country: "Norway",
      answer: "Electric vehicles reduce greenhouse gas emissions and reliance on fossil fuels.",
    ...
    },
    {
      ...
      region: "Asia",
      country: "Singapore",
      answer: "IoT refers to interconnected devices that communicate and exchange data over the internet.",
    ...
    },
    {
      ...
      region: "North America",
      country: "USA",
      answer: "5G networks provide faster speeds, lower latency, and improved connectivity for smart devices.",
    ...
    },
    {
      ...
      region: "Europe",
      country: "Sweden",
      answer: "Edge computing processes data closer to its source to reduce latency and bandwidth usage.",
    ...
    },
    {
      ...
      region: "Asia",
      country: "China",
      answer: "Quantum computers use qubits to perform calculations faster than classical computers.",
    ...
    },
    {
      ...
      region: "North America",
      country: "Mexico",
      answer: "Big data refers to extremely large data sets that require advanced tools for analysis.",
    ...
    },
    {
      ...
      region: "Europe",
      country: "Italy",
      answer: "Augmented reality overlays digital information onto the real world using devices like smartphones.",
      tags: ["AR", "tech", "visual"],
      date: "2025-02-25"
    },
    {
      ...
      region: "Asia",
      country: "South Korea",
      answer: "Virtual reality immerses users in a simulated 3D environment using headsets and sensors.",
    ...
    },
    {
      ...
      region: "Europe",
      country: "Spain",
      answer: "UI/UX design ensures digital interfaces are visually appealing and easy to use.",
      tags: ["design", "UI", "UX"],
      date: "2025-03-05"
    },
    {
      ...
      region: "Asia",
      country: "India",
      answer: "Responsive design ensures websites adapt to different screen sizes and devices.",
    ...
    },
    {
      ...
      region: "North America",
      country: "USA",
      answer: "APIs allow software applications to communicate and share data seamlessly.",
    ...
    },
    {
      ...
      region: "Europe",
      country: "UK",
      answer: "Digital transformation integrates digital technology into all areas of business operations.",
      ...
      <div className="ask-ibu-filter">
        {location.pathname !== "/account" && (
          <div className="filter-section">
            ...
            {true ? <div className="filter-container">
              <button
                ...
                <div className="filter-box">
                  ...
                  <div className="filter-group">
                    ...
                    <div
                      ...
                      onClick={() =>
                        setShowTagsDropdown(showTagsDropdown === "regions" ? "" : "regions")
                      }
                    >
                      <span>
                  ...
                  <div className="filter-group">
                    ...
                    <div
                      className="dropdown-toggle"
                      onClick={() =>
                        setShowTagsDropdown(showTagsDropdown === "countries" ? "" : "countries")
                      }
                    >
                      <span>
                    ...
                    {showTagsDropdown === "countries" && (
                      <div className="dropdown-list">
                        {countries.map((country, index) => (
                          <div
                            key={index}
                            className={`dropdown-option ${selectedCountries.includes(country) ? "selected" : ""
                              }`}
                  ...
                  <div className="filter-group">
                    ...
                    <div
                      className="dropdown-toggle"
                      onClick={() =>
                        setShowTagsDropdown(showTagsDropdown === "topics" ? "" : "topics")
                      }
                    >
                      <span>
        ...
        <div className="scroll-list">
          ...
          {
            return <QuestionCard question={question} key={index} account={false} />
          })}
        </div>
      </div>
        ...
        >
          ...
          <div className="disclaimer-box">
            <p className="disclaimer">
              Please don’t include any personal or confidential information in your
              question.
            </p>
