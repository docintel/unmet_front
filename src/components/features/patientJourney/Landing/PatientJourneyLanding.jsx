...
const PatientJourneyLanding = () => {
  ...
  const [isMobileSrceen, setIsMobileSrceen] = React.useState(
              ...
              <>
                <div className="explore-journey">
                  <div className="filter-age">
                    <h3>
                      Explore your <span>patient's Journey</span>
                    </h3>
                    <div className="explore-journey-block">
                            ...
                            <defs>
                              ...
                              >
                                ...
                                <feBlend
                                  ...
                                  result="effect1_dropShadow_3825_33796"
                                />
                                <feBlend
                                  mode="normal"
                                  in="SourceGraphic"
                                  in2="effect1_dropShadow_3825_33796"
                                  result="shape"
                                />
                              </filter>
                            </defs>
                            ...
                            <defs>
                              ...
                              >
                                ...
                                <feBlend
                                  mode="normal"
                                  in2="BackgroundImageFix"
                                  result="effect1_dropShadow_3825_33335"
                                />
                                <feBlend
                                  mode="normal"
                                  in="SourceGraphic"
                                  in2="effect1_dropShadow_3825_33335"
                                  result="shape"
                                />
                              </filter>
                            </defs>
                          ...
                          {filterAges.loading ? (
                            ...
                            filterAges.data.map((age, idx) => {
                              ...
                              return (
                                <div
                                  key={age.id}
                                  className={"block " + ageClassName}
                                >
                                  <p>{ageName}</p>
                                  <div className="line"></div>
                                  <div className="age-group-circle">
                                    <img
                                      src={path_image + "ages/" + age.allImage}
                                      alt=""
                                    />
                                  </div>
                                  <div className="age-gap">{ageGroup}</div>
                                </div>
                              );
                            })
                          )}
                      ...
                      <div className="explore-btn">
                        ...
                        >
                          Start exploring
                          {isMobileSrceen ? (
                            <img src={path_image + "arrow-right.svg"} alt="" />
                          ) : (
                            <img
