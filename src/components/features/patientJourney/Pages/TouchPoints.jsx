                            ...
                            <div className="touchpoint-box">
                                ...
                                <div className='touchpoints-header'>
                                    {/* <div className='touchpoint-links'>
                                        <Button variant="primary">Diagnosis</Button>
                                        <Button variant="primary">Surgery</Button>
                                        <Button variant="primary">Pregnancy & childbirth</Button>
                                        <Button variant="primary">Joint & bone health</Button>
                                        <Button variant="primary">HMB</Button>
                                        <Button variant="primary">Wilprophy</Button>
                                        <Button variant="primary">On-demand</Button>
                                    </div> */}
                                    <Tabs
                                        activeKey={activeKey}
                                                ...
                                                <div className='touchpoint-data-box' key={idx}>
                                                    ...
                                                    <div className='content-box'>
                                                        ...
                                                        <div className="tags tag-list">
                                                            {section.tags.map((tag, idx) => (<div key={idx}>
                                                                {tag}
                                                            </div>))}
                                                        </div>
                                                        <div className="date">
                                                        ...
                                                        <div className="favorite d-flex justify-content-between align-sections-center">
                                                            <div className='d-flex align-sections-center'>
                                                                <img
                                                                    src={path_image + (likedIndexes.includes(idx) ? "star-filled.svg" : "star-img.svg")}
                                                                    alt=""
